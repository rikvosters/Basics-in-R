...
grep("(i|ij|j)(ck|k)", words, value=T, ignore.case=T)
grep("[ij]{,2}(k|ck)", words, value=T, ignore.case=T)


# Write a regex to capture all words (singular and plural) ending in the suffix -ism
words <- c("fascism", "Bushisms", "antidisestablishmentarianism", "prism", "cow"); words
